          ...
          <div className="max-w-md w-full rounded-2xl border border-rose-800/60 bg-slate-900/90 p-6 sm:p-8 shadow-2xl backdrop-blur-xl text-center">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 flex items-center justify-center gap-1.5 rounded-xl bg-indigo-600 py-2.5 text-xs font-bold text-white hover:bg-indigo-500 transition-colors shadow-lg shadow-indigo-600/20"
              >
