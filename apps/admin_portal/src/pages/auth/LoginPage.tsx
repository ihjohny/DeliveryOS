      ...
      <div className="mt-6 border-t border-slate-800/80 pt-5">
        ...
        <div className="grid grid-cols-1 gap-2">
          <button
            ...
            className="flex items-center justify-between rounded-lg border border-slate-800 bg-slate-800/50 px-3 py-2.5 text-left text-xs transition-colors hover:border-primary-500/50 hover:bg-slate-800 text-slate-300"
          >
            <div>
              <span className="font-semibold text-primary-400 block">{t('auth.superAdmin')}</span>
              <span className="text-[10px] text-slate-400">Master Platform Governance & Fleet Dispatch</span>
            </div>
            <span className="text-[11px] font-mono text-slate-400">+8801700000001</span>
          </button>
        </div>
      </div>
    </div>
