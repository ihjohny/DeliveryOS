...
export const AdminLayout: React.FC = () => {
  ...
  const navItems = [
    { label: t('nav.admin.dashboard'), href: '/admin', icon: LayoutDashboard },
    { label: t('nav.admin.vendors'), href: '/admin/vendors', icon: Store },
    { label: t('nav.admin.dispatch'), href: '/admin/dispatch', icon: Navigation },
    { label: t('nav.admin.orders'), href: '/admin/orders', icon: FileText },
    { label: t('nav.admin.promotions'), href: '/admin/promotions', icon: Tag },
    { label: t('nav.admin.settings'), href: '/admin/settings', icon: Settings },
  ];
