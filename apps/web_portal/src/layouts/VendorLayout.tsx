...
export const VendorLayout: React.FC = () => {
  ...
  const navItems = [
    { label: t('nav.vendor.kds'), href: '/vendor', icon: UtensilsCrossed },
    { label: t('nav.vendor.catalog'), href: '/vendor/catalog', icon: Layers },
    { label: t('nav.vendor.orders'), href: '/vendor/orders', icon: History },
    { label: t('nav.vendor.settings'), href: '/vendor/settings', icon: Store },
  ];
