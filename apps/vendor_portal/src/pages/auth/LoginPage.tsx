      ...
      <div className="mt-6 border-t border-slate-800/80 pt-5">
        ...
        <div className="grid grid-cols-1 gap-2">
          <button
            ...
            className="flex items-center justify-between rounded-lg border border-slate-800 bg-slate-800/50 px-3 py-2.5 text-left text-xs transition-colors hover:border-amber-500/50 hover:bg-slate-800 text-slate-300"
          >
            <div>
              <span className="font-semibold text-amber-400 block">{t('auth.branchManager')}</span>
              <span className="text-[10px] text-slate-400">Single Outlet (Burger Point Banani)</span>
            </div>
            <span className="text-[11px] font-mono text-slate-400">+8801700000002</span>
          </button>

          <button
            type="button"
            onClick={() => handleQuickFill('+8801700000003')}
            className="flex items-center justify-between rounded-lg border border-slate-800 bg-slate-800/50 px-3 py-2.5 text-left text-xs transition-colors hover:border-orange-500/50 hover:bg-slate-800 text-slate-300"
          >
            <div>
              <span className="font-semibold text-orange-400 block">{t('auth.brandOwner')}</span>
              <span className="text-[10px] text-slate-400">Multi-Branch Chain Owner</span>
            </div>
            <span className="text-[11px] font-mono text-slate-400">+8801700000003</span>
          </button>
        </div>
      </div>
    </div>
